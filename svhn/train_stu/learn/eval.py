...
class Evaluator(BaseModel):
    def __init__(self, configs):
        ...
        self.test_loader = data.DataLoader(test_set, batch_size=configs.batch_size, shuffle=False, num_workers=0,
                                           drop_last=False)
    ...
    def evaluate(self):
        ...
        with torch.no_grad():
            ...
            for x, y in tq:
                ...
                tq.set_description("[{}] Top1: {:.4f}. Top5: {:.4f}. Loss: {:.4f}.".format("EMA", top1_ema_meter.avg,
                                                                                           top5_ema_meter.avg,
                                                                                           loss_ema_meter.avg))
        self.logger.info(
            "  [{}] Top1: {:.4f}. Top5: {:.4f}. Loss: {:.4f}.".format("EMA ", top1_ema_meter.avg, top5_ema_meter.avg,
                                                                      loss_ema_meter.avg))
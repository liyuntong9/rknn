...
eps = 4.0
delta = 1. / (73257 + 531131)
seed = 42


feats_dir = '/kolla/code/lyt/general_rknn/svhn/results'
...
test_feats = np.load(os.path.join('svhn_hog', 'test_data.npy'))
test_labels = np.load(os.path.join('svhn_hog', 'test_label.npy'))

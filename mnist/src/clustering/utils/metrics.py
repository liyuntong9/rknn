...
class Scores:
    ...
    def __init__(self, n_classes, n_clusters):
        ...
        self.max_order = max(n_classes, n_clusters)
    ...
    def compute_confusion_matrix(self):
        matrix = np.bincount(self.max_order * self.labels_true + self.labels_pred,
                             minlength=self.max_order**2).reshape(self.max_order, self.max_order)
